...
<div id="page" class="site">
	...
	if ( is_front_page() ) : ?>
		<div class="date-container">
			...
			</div> <span class="date-container__divider">|</span> 
			<div class="date-container__date">
				<em><?php echo get_theme_mod( 'armistice_location_text_2', 'default_value' ); ?> <?php echo get_theme_mod( 'armistice_date_text_2', 'default_value' ); ?></em><span class="date-container__icon date-container__icon--chron-2"><?php include('images/key.php'); ?></span></div>
			</div>
		<?php
